...
export const errors = {
  ...
  invalidSignature: (details: ErrorDetails) => new AppError("INVALID_SIGNATURE", "EIP-712 审批签名无效", 400, details),
  signatureExpired: (details: ErrorDetails) => new AppError("SIGNATURE_EXPIRED", "EIP-712 审批签名已过期", 400, details),
